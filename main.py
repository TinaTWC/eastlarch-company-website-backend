...
MOCK_PRODUCTS = [
    {
        ...
        "category": "無耗氣電子式排水器",
        "specs": {
            "型號": "FE110｜FE220｜PFE220",
            "專利字號": "中華民國專利證書字號 M683135",
            "耐壓": "≤ 16 bar（PFE220 ≤ 26 bar）",
            "耐溫": "≤ 80 °C",
            "電壓": "AC 110V / AC 220V",
            "最大排水量": "≤ 6 L/min",
            "桶身材質": "全透明耐壓特殊材質",
        ...
        # 三個型號共用機體，僅電壓與耐壓不同，故以並列比較表呈現而非拆成三筆產品
        "spec_variants": {
            "columns": ["規格一", "規格二", "規格三"],
            "rows": [
                {"label": "型號", "values": ["FE110", "FE220", "PFE220"]},
                {"label": "電壓", "values": ["AC 110V", "AC 220V", "AC 220V"]},
                {"label": "耐壓", "values": ["≤ 16 bar", "≤ 16 bar", "≤ 26 bar"]},
                {"label": "耐溫", "values": ["≤ 80 °C", "≤ 80 °C", "≤ 80 °C"]},
                {"label": "入口管徑", "values": ["G 1/2\" 內牙", "G 1/2\" 內牙", "G 1/2\" 內牙"]},
                {"label": "出口管徑", "values": ["G 1/2\" 內牙", "G 1/2\" 內牙", "G 1/2\" 內牙"]},
                {"label": "最大排水量", "values": ["≤ 6 L/min", "≤ 6 L/min", "≤ 6 L/min"]},
                {"label": "特色", "values": ["小排水 AC110V", "小排水 AC220V", "耐高壓 AC220V"]},
            ],
        },
        "features": [
